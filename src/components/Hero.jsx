      ...
      <div className="container items-center lg:grid lg:grid-cols-2 lg:gap-10">
        <div>
          <div className="flex items-center gap-3">
            <figure className='img-box w-9 h-9 rounded-lg'>
              <img src="/images/image.png" width={40} height={40} alt="" className="img-cover" />
            </figure>
          ...
          <div className=" flex items-center gap-3 ">
           <ButtonPrimary label="Download CV" href="/cv.pdf" target="_blank" icon="download"/>
        ...
        <div className="hidden lg:block ">
            <figure className="w-full max-w-[480px] ml-auto bg-gradient-to-t from-sky-400 via-25% via-sky-400/40 to-65% rounded-[60px] overflow-hidden ">
                <img src="/images/image.png" width={656} height={800} alt="" className='w-full' />
            </figure>
        </div>
      </div>
    </section>
